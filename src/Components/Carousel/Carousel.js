      ...
      <div className="carousel">
        <Slider {...settings}>
            <div className="carousel-background">         
              <div className="carousel-img-container" style={{backgroundImage: `url(${bg1})`}}>
            ...
            <div className="carousel-background">             
              <div className="carousel-img-container" style={{backgroundImage: `url(${bg2})`}}>
              <div className="carousel-overlay"></div>
                <TitleComponent 
                  goldTitle="Welcome"
            ...
            <div className="carousel-background">
              <div className="carousel-img-container" style={{backgroundImage: `url(${bg3})`}}>
              <div className="carousel-overlay"></div>
                <TitleComponent 
                  goldTitle="Welcome"
